        ...
        <div className = "signinContainer">
            <div className = "signinOuter">
                <div className = "inputOuterBox">
                    ...
                    <input className='inputBox' type = "text" placeholder='닉네임을 입력하세요' name = "username" value = {user.username} onChange = {handleUserSetting}></input>
                </div>
                <div className = 'inputOuterBox'> 
                    <div className='inputOuterBox'>
                        비밀번호
                    </div>
                    <input className='inputBox' type = "password" placeholder='비밀번호를 입력하세요' name = "password" value = {user.password} onChange = {handleUserSetting}></input>
                </div>
